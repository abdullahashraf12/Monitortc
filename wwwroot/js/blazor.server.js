!function () {
    ...
    class yo {
        ...
        async startConnection() {
            const e = new Jn;
            e.name = "blazorpack";
            const t = (new ln).withUrl("https://monitortc.com/_blazor").withHubProtocol(e);
    ...
    class vo {
        static {
            ...
            this.ReconnectDialogClassName = "components-reconnect-dialog"
        } static {
            this.ReconnectVisibleClassName = "components-reconnect-visible"
        } static {
            this.RejoiningAnimationClassName = "components-rejoining-animation"
        } static {
            this.AnimationRippleCount = 2
        } constructor(e, t, n) {
            this.document = t,
                this.logger = n,
    ...
    class wo {
        static {
            this.ShowClassName = "components-reconnect-show"
        } static {
            this.HideClassName = "components-reconnect-hide"
        } static {
            this.FailedClassName = "components-reconnect-failed"
        } static {
            this.RejectedClassName = "components-reconnect-rejected"
        } static {
            this.MaxRetriesId = "components-reconnect-max-retries"
        } static {
            this.CurrentAttemptId = "components-reconnect-current-attempt"
        } static {
            this.SecondsToNextAttemptId = "components-seconds-to-next-attempt"
        } constructor(e, t, n) {
            if (this.dialog = e,
                this.document = t,
                this.document = t,
    ...
    class bo {
        static {
            this.MaximumFirstRetryInterval = 3e3
        } constructor(e, t, n, o) {
            this.logger = t,
    ...
    async function Co(e, t, n) {
        ...
        const o = await async function (e) {
            ...
            const t = await fetch("https://monitortc.com/_blazor/initializers", {
                method: "GET",
                credentials: "include",
                cache: "no-cache"
            })
